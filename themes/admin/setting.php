		...
		echo $this->upload->display_errors("<p>","</p>");
		 ?>
		  <fieldset>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      <label for="inputUser" class="col-lg-2 control-label">العملة</label>
		      <div class="col-lg-10 input-grup">
		        <input type="text" class="form-control text-right" name="currency" value="<?php echo $key->currency; ?>">
		      </div>
		    </div>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      <label for="inputUser" class="col-lg-2 control-label">فيس بوك بيكسل id</label>
		      <div class="col-lg-10 input-grup">
		        <textarea rows="12" name="fbpixel" class="form-control" placeholder="xxxxxxxxxxxxxxxx &#10;xxxxxxxxxxxxxxxx"><?php echo $key->fbpixel; ?></textarea>
		      </div>
		    </div>
