	...
	<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
		<?php echo form_open_multipart("",array("class" => "form-horizontal")); ?>
		  ...
		  <fieldset>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      <label for="inputUser" class="col-lg-2 control-label">الإختيارات</label>
		      <div class="col-lg-10 input-grup">
		      	<div class="row">
			        <div class="col-md-5">
			        	<input type="" name="tp[]" placeholder="الإختيار" class="form-control">
			        </div>
			        <div class="col-md-5">
			        	<input type="" name="info[]" placeholder="الإختيارات المتاحة" class="form-control">
			        </div>
			        <div class="col-md-2">
			        	<a style="cursor: pointer;height: 40px;display: block;" onclick="addOptions(this);"><i class="fa fa-plus" style="color: green;"></i></a>
			        </div>
			    </div>
		      </div>
		    </div>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      ...
		      <div class="col-lg-10 input-grup">
				...
				foreach($info as $in){
		      	...
		      	<div class="row">
			        <div class="col-md-5">
			        	<input type="" name="tp[]" placeholder="الإختيار" class="form-control" value="<?php echo $in->tp; ?>">
			        </div>
			        <div class="col-md-5">
			        	<input type="" name="info[]" placeholder="الإختيارات المتاحة" class="form-control" value="<?php echo $in->info; ?>">
			        </div>
			        <div class="col-md-2">
			        	<?php if($i == 0){ ?>
			        		<a style="cursor: pointer;height: 40px;display: block;" onclick="addOptions(this);"><i class="fa fa-plus" style="color: green;"></i></a>
			        	<?php }else{ ?>
			        		<a style="cursor: pointer;height: 40px;display: block;" class="deleteIt"><i class="fa fa-minus" style="color:red;"></i></a>
			        	<?php } ?>
			        </div>
			    </div>
			...
			<tr>
				...
				<td data-title="التحكم" class="text-center">
					<a href="<?php echo base_url("admin/edit_product/$key->id"); ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil-square"></i> تعديل</a>
           			<a href="<?php echo base_url("admin/delt/products/$key->id/products"); ?>" class="btn btn-danger btn-xs deleteBtn"><i class="fa fa-minus-square"></i> حذف</a>
				</td>
			</tr>
		<?php } ?>
