...
<?php foreach($msg as $key){ ?>
	...
	<table class="table" style="text-align: right;">
		...
		$pcs = json_decode($key->products, TRUE); foreach($pcs as $p) {
...
<div class="form-group">
	...
	<label>المدينة : </label>
	<input type="text" name="city" class="form-control" value="<?php echo $key->city; ?>">
...
<div class="form-group">
	...
	<input type="text" name="tele" class="form-control" value="<?php echo $key->tele; ?>">
