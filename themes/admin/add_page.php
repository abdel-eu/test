<?php $title='إضافة عرض'; require_once 'views/head.php'; ?>
	...
	<?php if(isset($msg)){ ?>
	<div class="alert alert-success">تم إضافة الصفحة بنجاح .</div>
	<?php } ?>
		  ...
		  <fieldset>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      ...
		      <div class="col-lg-10 input-grup">
		        ...
		        <input type="text" class="form-control text-right" placeholder="عنوان الصفحة" name="title">
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      ...
		      <div class="col-lg-10 input-grup">
		        <textarea class="form-control text-right" name="content" id="editor1"></textarea>
