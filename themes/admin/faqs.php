	...
	<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
		<?php echo form_open_multipart("",array("class" => "form-horizontal")); ?>
		  ...
		  <fieldset>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      <label for="inputUser" class="col-lg-2 control-label">نسبة التخفيض</label>
		      <div class="col-lg-10 input-grup">
		        <input type="number" value="0" class="form-control text-right" placeholder="نسبة التخفيض" name="num">
		        <span class="help-block">نسبة التخفيض .</span>
		      </div>
		    </div>
		...
		<?php echo form_open_multipart("",array("class" => "form-horizontal")); ?>
		  ...
		  <fieldset>
		    ...
		    <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
		      <label for="inputUser" class="col-lg-2 control-label">نسبة التخفيض</label>
		      <div class="col-lg-10 input-grup">
		        <input type="number" class="form-control text-right" placeholder="نسبة التخفيض" name="num"  value="<?php echo $key->num; ?>">
		        <span class="help-block">نسبة التخفيض .</span>
		      </div>
		    </div>
			...
			<tr>
				...
				<td data-title="التحكم" class="text-center">
					<a href="<?php echo base_url("admin/edit_discount/$key->id"); ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil-square"></i> تعديل</a>
           			<a href="<?php echo base_url("admin/delt/discounts/$key->id/discounts"); ?>" class="btn btn-danger btn-xs deleteBtn"><i class="fa fa-minus-square"></i> حذف</a>
				</td>
			</tr>
		<?php } ?>
